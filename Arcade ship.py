...
def restart():
    ...
    intro_text = ['Ты был уничтожен.',
                  'Ты унчтожил:   ' + str(death),
                  'Для игры того, чтобы играть заного, нажмите "Space"']
...
def start_screen():
    intro_text = ["Star Ship", "",
                  ...
                  "Если вы долго будете убивать противников, то", "они начнут использовать запутанную "
                  "траекторию полета снарядов, бойтесь, их тактики коварны.",
                  "Цель игры:",
